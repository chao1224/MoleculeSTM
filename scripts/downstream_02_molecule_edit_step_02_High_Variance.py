...
def get_molecule_repr_generation(molecule_data, molecule_model, molecule_type="SMILES", MegaMolBART_wrapper=None):
...
if __name__ == "__main__":
    ...
    mol_repr = get_molecule_repr_generation(
        source_SMILES_list, molecule_model=molecule_model_generation,
